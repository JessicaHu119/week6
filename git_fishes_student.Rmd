...
```{r}
## The path to my image `output/figures/` appears in '.gitignore', while two png files appear in GitHub Desktop.  Because the path to the image is hidden on '.gitignore', the web site will hide my image.
```
