...
## A light red highlight indicates that this paragraph has been modified, a dark red highlight indicates that the content inside has been removed, and a green highlight indicates that I have added something, perhaps code or some text description, etc.
```
